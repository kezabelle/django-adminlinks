# -*- coding: utf-8 -*-
#
# django-adminlinks documentation build configuration file, created by
...
htmlhelp_basename = 'django-adminlinksdoc'
...
latex_documents = [
  ('index', 'django-adminlinks.tex', u'django-adminlinks Documentation',
...
man_pages = [
    ('index', 'django-adminlinks', u'django-adminlinks Documentation',
     [u'Keryn Knight'], 1)
]
...
texinfo_documents = [
  ('index', 'django-adminlinks', u'django-adminlinks Documentation',
   u'Keryn Knight', 'django-adminlinks', 'One line description of project.',
   'Miscellaneous'),
]
